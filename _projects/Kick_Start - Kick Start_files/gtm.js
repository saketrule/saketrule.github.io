...
var v=Xh(a,t,e);h=v.F;k=v.D}return function(){t[a](q,u)}}return e}function Xh(a,b,c){var d=[],e=[];b[a]=Yh(d,e,c);return{F:function(){b[a]=Zh;for(var f=0;f<d.length;f++)d[f]()},D:function(){b[a]=$h;for(var f=0;f<e.length;f++)e[f]()}}}function Yh(a,b,c){return function(d,e){a.push(d);b.push(e);c()}}function Zh(a){a()}function $h(a,b){b()};var ci=function(a,b,c){for(var d=[],e=0;e<Fb.length;e++)if(a[e]){var f=Fb[e];if(f[Qb.bg])continue;var h=c.add();try{var k=Vh(e,{F:h,D:h,terminate:h},b,e);k?d.push({cf:e,Xe:Ob(f),Sg:k}):(ai(e,b),h())}catch(n){h()}}c.vg();d.sort(bi);for(var l=0;l<d.length;l++)d[l].Sg();return 0<d.length};function bi(a,b){var c,d=b.Xe,e=a.Xe;c=d>e?1:d<e?-1:0;var f;if(0!==c)f=c;else{var h=a.cf,k=b.cf;f=h>k?1:h<k?-1:0}return f}
...
var Tm=function(a,b,c){for(var d={},e=!1,f=0;a&&f<a.length;f++)a[f]&&a[f].hasOwnProperty(b)&&a[f].hasOwnProperty(c)&&(d[a[f][b]]=a[f][c],e=!0);return e?d:null};Pm.kh=function(){var a=!1;a=!0;return a};function co(){return F.gaGlobal=F.gaGlobal||{}}var eo=function(){var a=co();a.hid=a.hid||Ca();return a.hid},fo=function(a,b){var c=co();if(void 0==c.vid||b&&!c.from_cookie)c.vid=a,c.from_cookie=b};var Go=window,Ho=document,Io=function(a){var b=Go._gaUserPrefs;if(b&&b.ioo&&b.ioo()||a&&!0===Go["ga-disable-"+a])return!0;try{var c=Go.external;if(c&&c._gaUserPrefs&&"oo"==c._gaUserPrefs)return!0}catch(f){}for(var d=Fe("AMP_TOKEN",String(Ho.cookie),!0),e=0;e<d.length;e++)if("$OPT_OUT"==d[e])return!0;return Ho.getElementById("__gaOptOutExtension")?!0:!1};function Lo(a){delete a.eventModel[C.rb];No(a.eventModel)}
